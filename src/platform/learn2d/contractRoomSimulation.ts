import { contractRaidRoster, CONTRACT_EVENT_SECONDS, CONTRACT_LANDING_SECONDS, seededContractEvents, type ContractDirection, type ContractEvent, type ContractRaidMember } from '../contractRoom'
...
export function contractRaidPosition2D(member: ContractRaidMember) {
  if (member.controlled) return { x: 50, y: 68 }
