...
export default function SentinelsFullFight2D({ trainingDifficulty, keyBindings, actions, hudSettings, onExit }: EncounterRuntimeProps) {
  ...
  return <main className="training-shell sentinels-runtime">
    ...
    <section className="training-runtime-layout arena-only"><div className="learn2d-stage"><div className="learn2d-arena-frame"><RaidLeadTelegraph current={activeSentinelsPrompt(view)} nextLabel={timer.label} nextSeconds={timer.seconds} /><div className="learn2d-board sentinels-2d-board" aria-label="Entombed Sentinels raid-plan training arena" style={{ '--sentinels-plan': `url(${RAID_PLAN})` } as CSSProperties}>
