...
export const learn2dScenarios = [
  { ...shared, id: 'nekzali_full_fight', name: 'Full fight', kind: 'full-fight', mode: 'learn2d', abilityIds: ['nekzali_soulcoil_well', 'nekzali_essence_rend', 'nekzali_possession_barrage', 'nekzali_hollowing_strikes', 'nekzali_restless_amani', 'nekzali_hungering_pyre', 'nekzali_cremation', 'nekzali_invoke', 'nekzali_grasping_depths', 'nekzali_drowned_echo', 'nekzali_swirling_spirits', 'nekzali_soul_exhaustion', 'nekzali_disruption'], steps: ['Read your role, soak group, and well half.', 'Resolve the active phase and assigned Well realm.', 'Alternate Echo soak and spread.', 'Survive the moving Cultist field in Phase 2.'] },
