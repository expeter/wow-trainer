...
export const phases = [
  ...
  { id: 'nekzali_mythic_well', name: 'Grasping Depths', description: 'Assigned Mythic raid half defeats and interrupts the Drowned Echo inside the Well realm.', abilityIds: ['nekzali_grasping_depths', 'nekzali_drowned_echo', 'nekzali_swirling_spirits', 'nekzali_soul_exhaustion', 'nekzali_disruption'] },
