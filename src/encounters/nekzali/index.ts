...
export default { apiVersion: 1, manifest, abilities, phases, roles, timingProfiles: [ptrTiming], tacticSchema, tactics: [defaultTactic], learn2d: learn2dScenarios, train3d: train3dScenarios, train3dArenas,
