...
test('boots the standalone Season 2 shell with the first package runtimes ready', async ({ page }) => {
  ...
  await expect(tactics).toContainText('Fight flow and responsibilities')
  await expect(tactics).toContainText('Claim assigned Toxic Droplets, dodge outgoing and returning venom')
