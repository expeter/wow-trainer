...
| --- | ---: | ---: | --- |
| Initial shell JavaScript | 72.59 KiB gzip | 87.89 KiB | Required by setup |
| Initial shell CSS | 25.38 KiB gzip | 34.18 KiB | Required by setup |
| Three.js renderer chunk | 144.35 KiB gzip | 170.90 KiB | Lazy; Train 3D only |
| Lost Explorers raid plan | 2.19 MB source | Evidence asset | Painted only in Lost Explorers Learn 2D |
...
The 2026-08-18 acceptance run completed the focused Lost Explorers and contract
room slice in 25.3 seconds (2 tests) and the complete suite in 2.6 minutes (21
tests), both with one worker and zero retries.
