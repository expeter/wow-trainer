...
| --- | ---: | ---: | --- |
| Initial shell JavaScript | 72.60 KiB gzip | 87.89 KiB | Required by setup |
| Initial shell CSS | 25.53 KiB gzip | 34.18 KiB | Required by setup |
| Three.js renderer chunk | 144.60 KiB gzip | 170.90 KiB | Lazy; Train 3D only |
...
The 2026-08-18 acceptance run completed the focused three-boss launch slice in
18.7 seconds (1 test) and the complete suite in 2.9 minutes (22 tests), both
