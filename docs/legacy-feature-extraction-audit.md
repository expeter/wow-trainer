...
| Exact SemVer, Git revision, build UTC, copy action | Extracted in current batch | `CR-246` |
| Relative `version.json` polling and Load new version/Later prompt | Extracted in current batch | `CR-246` |
| Persistent movement bindings, inversion, sensitivity, zoom | Extracted | `BUG-157`, `BUG-161` |
...
| Stable failure review, recap and offline share/result identity | Active gap | `FR-080` |
